...
1.说一个最感兴趣的项目，一直问，问到不会。    2.linux下零拷贝，linux的内核同步。    3.select和epoll区别    4.知道什么是写复制么    5.fork（）子进程与父进程什么区别，什么情况下会进行写时复制。    6.tcp怎么保证数据传输可靠    7.tcp粘包问题    8.tcp拥塞控制    9.tcp time_wait存在的意义    10.new 和 malloc 区别    11.c++怎么实现多态    12.虚函数实现机制    13.构造函数可以是虚函数么，析构函数呢    14.虚函数和普通成员函数哪个快，虚函数能内联么。    15.两个栈实现一个队列    16.平时关注什么开源项目，在哪看的。
...
作者：懒懒懒
链接：https://www.nowcoder.com/discuss/27801?type=2&order=3&pos=55&page=1
来源：牛客网
